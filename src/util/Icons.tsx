...
export type CustomIconType = ((props: IconProps) => JSX.Element) | ForwardRefExoticComponent<IconProps & RefAttributes<SVGSVGElement>>
...
export function IconWalkieTalkie(props: IconProps = defaultProps) {

    const { width, height, color, stroke, ...rest } = props;

    return (
        <svg {...rest} xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" color={color} strokeWidth={0.4} fill="currentColor">
...
export function IconWhistle(props: IconProps = defaultProps) {

    const { width, height, color, stroke, ...rest } = props;

    return (
        <svg {...rest} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={width} height={height} color={color} strokeWidth={0} fill="currentColor">
